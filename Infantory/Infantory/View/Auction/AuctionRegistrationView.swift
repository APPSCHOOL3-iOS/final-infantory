                    ...
                    ZStack {
                        ...
                        Button {
                            if title.isEmpty {
                                ...
                                showAlert = true
                                alertMessage = "최고가를 입력해주세요."
                            } else {
                                Task {
                                    try await registViewModel.createAuctionProduct(title:title, apply:apply, itemDescription:itemDescription, startingPrice:startingPrice, maximumPrice:maximumPrice)
                                }
                            }
                            //                            dismiss()
                        } label: {
